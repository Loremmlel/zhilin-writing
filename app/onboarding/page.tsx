...
export default async function OnboardingPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <main className="centered-page onboarding-page">
      <form action={createProfileAction} className="quiet-card onboarding-card">
        ...
        <label>
          ...
          <textarea className="text-area" name="bio" maxLength={300} rows={4} placeholder="写一点你愿意让朋友知道的事情……" />
        </label>
