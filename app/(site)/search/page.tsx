...
export default async function SearchPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return (
    <div className="page-column">
      ...
      <form action="/search" className="search-page-form" noValidate><input className="text-input" name="q" defaultValue={query} placeholder="输入标题或正文中的词语" autoFocus /><button className="button button--primary">搜索</button></form>
