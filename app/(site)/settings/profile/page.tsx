...
export default async function ProfileSettingsPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return (
    <div className="page-column settings-page">
      ...
      <form action={updateProfileAction} className="settings-form" noValidate>
        ...
        <label><span className="field-label">个人简介</span><textarea className="text-area resize-none" name="bio" defaultValue={member.bio} maxLength={300} rows={5} /></label>
