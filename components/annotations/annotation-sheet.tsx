...
export function AnnotationSheet({ annotation, open, onClose, currentUserId, replyAction, deleteAction, deleteReplyAction }: {
  ...
  return <ModalDialog open={open} title="正文批注" description={`选中文字：${annotation.originalSelectedText}`} onClose={onClose} surfaceClassName="annotation-sheet-surface" backdropClassName="annotation-sheet-backdrop">
